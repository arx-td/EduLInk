...
const deleteSclass = async (req, res) => {
    ...
    try {
        const deletedClass = await Sclass.findByIdAndDelete(req.params.id, { session });
        if (!deletedClass) {
        ...
        await Student.deleteMany({ school: req.params.id }, { session });
        await Subject.deleteMany({ school: req.params.id }, { session });
        await Teacher.deleteMany({ school: req.params.id }, { session });
